...
if st.session_state.get("youtube_creds") is not None:
    ...
    if channel_id is not None:
        ...
        if sort_order == "Newest First": display_comments = sorted(display_comments, key=lambda x: x["snippet"]["topLevelComment"]["snippet"]["publishedAt"], reverse=True)
        elif sort_order == "Oldest First": display_comments = sorted(display_comments, key=lambda x: x["snippet"]["topLevelComment"]["snippet"]["publishedAt"], reverse=False)
